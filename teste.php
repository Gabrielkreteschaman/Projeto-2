<?php
    ...
    if ($formaPagamento == "debito") {
        ...
        $pagamentoTexto = $pagamento->pagar();
    ...
    echo "Data: " . $cliente->getData() . "<br><br><hr>";
    ...
    echo "Preço: R$ " . number_format($produto->getPreco(), 2, ",", ".") . "<br><br><hr>";

    echo "<h2>Forma de Pagamento:</h2>";
    echo "Forma de Pagamento escolhido: " . $pagamentoTexto . "<br><br><hr>";
